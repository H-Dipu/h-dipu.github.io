      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
          ...
          <textarea
              id="message"
              rows="5"
              class="form-control" v-model="userData.message">
                    </textarea>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
          ...
          <select
            ...
            <option v-for="priority in priorityData" :key="priority">
              {{priority}}
            </option>
          </select>
        </div>
...
export default {
  data(){
    return{
      ...
      sendmail:[],
      selectedPriority:'Select one',
      priorityData:['Select one','1st Class','2nd Class','3rd Class']
    }
  }
}
</script>
